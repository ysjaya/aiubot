...
function App() {
  ...
  const importSelectedFiles = async () => {
    ...
    try {
      ...
      if (data.success) {
        alert(`✅ Imported ${data.imported_count} files`);
        await loadAttachments(selectedConv.id);
        ...
        <div className="modal-overlay" onClick={() => setShowGitHubImport(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="btn-close" onClick={() => setShowGitHubImport(false)}>
                ✕
              </button>
            </div>
            ...
            <div className="modal-body">
              {!githubToken ? (
                <div style={{ textAlign: 'center', padding: '40px' }}>
                  ...
                  <button className="btn-primary" onClick={handleGitHubAuth}>
                    🔐 Connect GitHub
                  </button>
                </div>
              ) : !selectedRepo ? (
                <>
                  <div style={{ marginBottom: '20px', display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <button className="btn-secondary" onClick={loadGitHubRepos}>
                      🔄 Refresh
                    </button>
                  </div>
            ...
            {selectedRepo && (
              <div className="modal-footer">
                ...
                >
                  {importProgress ? '⏳ Importing...' : `Import ${selectedFiles.size} files`}
                </button>
              </div>
            )}
          </div>
